...
public class JaxbUtils {
    ...
    public Object getObject(InputStream is, SchemaType schemaType) throws TransferException {
        ...
        try {
            ...
            uk.org.gigs2go.tableserver.core.data.Result error = new uk.org.gigs2go.tableserver.core.data.Result();
            error.setSuccess(uk.org.gigs2go.tableserver.core.data.Result.FAIL);
